        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ Route('editor.blogCategory.index') }}">Blog Categories</a>
                    </li>
...
<section class="content">
    <div class="container-fluid">
        ...
        @endif
        <form method="POST" action="{{ Route('editor.blogCategory.store') }}" enctype="multipart/form-data">
            @csrf
